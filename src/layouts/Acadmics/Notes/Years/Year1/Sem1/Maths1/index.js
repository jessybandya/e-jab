    ...
    <div>
       {topic1 ?(
           ...
           <div style={{display: "flex", justifyContent: "space-between"}}>
            <div><ArrowBackIosNewIcon fontSize="medium" style={{cursor: "pointer"}} onClick={() => setTopic1(false)}/></div><div><h3>Topic 1</h3></div><div></div>
           </div>
           <hr />
           <Topic1 />
           </div>
        ...
        <div>
        <div style={{display: "flex", justifyContent: "space-between"}}>
         <div><ArrowBackIosNewIcon fontSize="medium" style={{cursor: "pointer"}} onClick={() => setTopic2(false)}/></div><div><h3>Topic 2</h3></div><div></div>
        </div>
        <hr />
        <Topic2 />
        </div>
        ...
        <div>
        <div style={{display: "flex", justifyContent: "space-between"}}>
         <div><ArrowBackIosNewIcon fontSize="medium" style={{cursor: "pointer"}} onClick={() => setTopic3(false)}/></div><div><h3>Topic 3</h3></div><div></div>
        </div>
        <hr />
        <Topic3 />
        </div>
        ...
        <div>
        <div style={{display: "flex", justifyContent: "space-between"}}>
         <div><ArrowBackIosNewIcon fontSize="medium" style={{cursor: "pointer"}} onClick={() => setTopic4(false)}/></div><div><h3>Topic 4</h3></div><div></div>
        </div>
        <hr />
        <Topic4 />
        </div>
        ...
        <div>
        <div style={{display: "flex", justifyContent: "space-between"}}>
         <div><ArrowBackIosNewIcon fontSize="medium" style={{cursor: "pointer"}} onClick={() => setTopic5(false)}/></div><div><h3>Topic 5</h3></div><div></div>
        </div>
        <hr />
        <Topic5 />
        </div>
